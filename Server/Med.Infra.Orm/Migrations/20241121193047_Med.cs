        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Atividades_AspNetUsers_UsuarioId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AtividadeMedico", x => new { x.AtividadeId, x.MedicoId });
                    table.ForeignKey(
                        name: "FK_AtividadeMedico_Atividades_AtividadeId",
                        column: x => x.AtividadeId,
                        principalTable: "Atividades",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AtividadeMedico_Medicos_MedicoId",
                        column: x => x.MedicoId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AtividadeMedico_MedicoId",
